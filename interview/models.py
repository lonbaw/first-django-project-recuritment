...
class Candidate(models.Model):
    ...
    # HR终面
    hr_score = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'HR复试综合等级',help_text=u'1-5分，极优秀: >=4.5，优秀: 4-4.4，良好: 3.5-3.9，一般: 3-3.4，较差: <3分')
    ...
    class Meta:
        ...
        verbose_name = u'应聘者'
        verbose_name_plural = u'应聘者' #复数形式
